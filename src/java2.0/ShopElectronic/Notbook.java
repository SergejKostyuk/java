...
public class Notbook {
    ...
    public Notbook (String name, int ramInGB, int valueHDD, String operatingSystem, String color) {
        this.name = name;
    ...
    public boolean equals(Object obj) {
        ...
        Notbook  note = (Notbook) obj;
        return name.equals(note.name) && ramInGB == note.ramInGB && valueHDD == note.valueHDD && operatingSystem.equals(note.operatingSystem) && color.equals(note.color);
    }
